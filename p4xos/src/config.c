...
static const char usage[] =
    ...
    "               \n"
    "    --rx \"(PORT, QUEUE, LCORE), ...\" : List of NIC RX ports "
    "and queues       \n"
    "           handled by the I/O RX lcores                         "
    "               \n"
    "    --tx \"(PORT, LCORE), ...\" : List of NIC TX ports handled "
    "by the I/O TX   \n"
    "           lcores                                               "
    "               \n"
    ...
    "               \n"
    "           A = Size (in number of buffer descriptors) of each "
    "of the NIC RX    \n"
    "               rings read by the I/O RX lcores (default value "
    "is %u)           \n"
    "           B = Size (in number of elements) of each of the SW "
    "rings used by the\n"
    "               I/O RX lcores to send packets to worker lcores "
    "(default value is\n"
    "               %u)                                              "
    "               \n"
    "           C = Size (in number of elements) of each of the SW "
    "rings used by the\n"
    ...
    "of the NIC TX    \n"
    "               rings written by I/O TX lcores (default value is "
    "%u)            \n"
    ...
    "               is %u)                                           "
    "               \n"
    "           F = I/O TX lcore write burst size to NIC TX (default "
    "value is %u)   \n"
    "    --pos-lb POS : Position of the 1-byte field within the "
    "input packet used by\n"
    "           the I/O RX lcores to identify the worker lcore for "
    "the current      \n"
    "           packet (default value is %u)                         "
    "               \n"
    "    --msgtype MSGTYPE : Type of p4xos packets (default value is "
    "%u)            \n"
    "    --baseline : Enable baseline mode (Do nothing) (default "
    "value is %u)       \n"
    "    --multi-dbs : Enabling multiple instance of DBs (default "
    "value is %u)      \n"
    "    --reset-inst: Reset leader instance (default value is %u)   "
    "               \n"
    "    --inc-inst : Proposer increases instance after receiving a "
    "response        \n"
    "					(default value is %u)   "
    "                                    \n"
    ...
    "               \n"
    "    --port [PORT]: TX port Proposers use initially (default "
    "value is %u)       \n"
    ...
    "(default value is %u) \n"
    "    --ts-interval NUM : The interval between get time (default "
    "value is %u)    \n"
    ...
    "                   (default value is %s)			"
    "							\n"
    "    --dst \"IP\" : destination IP address proposers uses to "
    "generate packets   \n"
    "                   (default value is %s)			"
    "							\n";
